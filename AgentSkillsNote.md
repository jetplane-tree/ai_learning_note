...
## 使用skill
### 通过 Claude API
看这个[笔记本](https://github.com/https-deeplearning-ai/sc-agent-skills-files/blob/main/L5/lesson_5.ipynb)

### 通过ClaudeCode
- cc的三个工作阶段：**收集上下文**、**采取行动**和**验证结果**
- 跨分支工作
...
```
详细[代码说明](https://github.com/datawhalechina/agent-skills-with-anthropic/blob/main/9.Skills%20with%20the%20Claude%20Agent%20SDK%EF%BC%88Claude%20Agent%20SDK%20%E4%B8%AD%E7%9A%84%E6%8A%80%E8%83%BD%EF%BC%89.md)
